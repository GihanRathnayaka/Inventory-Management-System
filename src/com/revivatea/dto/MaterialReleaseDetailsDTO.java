...
public class MaterialReleaseDetailsDTO extends SuperDTO {
    ...
    public MaterialReleaseDetailsDTO() {
    }

    public MaterialReleaseDetailsDTO(String matRdID, double releaseqty, double total, String releaseID, String rowMatID) {
